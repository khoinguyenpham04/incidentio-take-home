...
This script generates an on-call schedule based on a rotating schedule configuration and applies overrides to produce a final schedule within a specified time range.

Author: Tran Khoi Nguyen (Noah) Pham.
"""
